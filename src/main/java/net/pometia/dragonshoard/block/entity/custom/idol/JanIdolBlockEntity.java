...
public class JanIdolBlockEntity extends BlockEntity {
    ...
    public JanIdolBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntities.JAN_IDOL_BE.get(), pos, blockState);
        };
    ...
    public CompoundTag getUpdateTag(HolderLookup.Provider registries) {
        ...
        public static void clientTick (Level level, BlockPos pos, BlockState state, JanIdolBlockEntity blockEntity){
        ...
        public static void serverTick (Level level, BlockPos pos, BlockState state, JanIdolBlockEntity blockEntity){
        ...
        private static void updateHunting (JanIdolBlockEntity blockEntity, List < BlockPos > enhancingBlocks){
        ...
        state, List < BlockPos > enhancingBlocks, JanIdolBlockEntity blockEntity){
        ...
        private static void updateClientTarget (Level level, BlockPos pos, JanIdolBlockEntity blockEntity){
                ...
                for (int j = -4; j <= 4; j++) {
                    for (int kx = -4; kx <= 4; kx++) {
                        ...
                        BlockState blockState = level.getBlockState(blockPos2);
                            ...
                            if (blockState.is(ModTags.Blocks.JAN_FAVORED_BLOCKS_VALUE_1)) {
            ...
            for (int i = -4; i <= 4; i++) {
                for (int j = -4; j <= 4; j++) {
                    for (int kx = -4; kx <= 4; kx++) {
                        ...
                        if (blockState.is(ModTags.Blocks.JAN_FAVORED_BLOCKS_VALUE_2)) {
                            enhancingBlocks.add(blockPos2);
                            enhancingBlocksVal2.add(blockPos2);
                        }

                        if (blockState.is(ModTags.Blocks.JAN_FAVORED_BLOCKS_VALUE_3)) {
                            enhancingBlocks.add(blockPos2);
                            enhancingBlocksVal3.add(blockPos2);
                        }
                        if (blockState.is(ModTags.Blocks.JAN_FAVORED_BLOCKS_VALUE_4)) {
                            enhancingBlocks.add(blockPos2);
                            enhancingBlocksVal4.add(blockPos2);
                        }
                        if (blockState.is(ModTags.Blocks.JAN_FAVORED_BLOCKS_VALUE_5)) {
                            enhancingBlocks.add(blockPos2);
